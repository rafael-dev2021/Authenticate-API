...
import myapp.authenticateAPI.infrastructure.security.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/user/users-active").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/v1/user/users-inactive").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/tag/tags").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/v1/tag/{id}").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/category/categories").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/v1/category/{id}").hasRole("ADMIN")
